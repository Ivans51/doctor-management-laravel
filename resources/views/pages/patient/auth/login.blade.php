        ...
        <div class="bg-white p-8 rounded max-w-xl">
            ...
            <form action="{{ route('patient.form.login') }}" method="post">
                ...
                <div class="space-y-6">
                    <div class="w-full">
                        ...
                        <input class="border w-full rounded" type="email" name="email" id="email"
                            value="patient@example.com" placeholder="josh@gmail.com">
                    </div>
                    <div class="w-full">
                        ...
                        <div class="relative">
                            <input class="border w-full rounded" type="password" name="password" id="password" value="password"
                                placeholder="*********">
                            <button type="button" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 focus:outline-none" onclick="togglePasswordVisibility('password')">
                ...
                <div class="text-right text-blue-500 my-5">
                    <a href="{{ route('patient.forgot') }}">Forgot Password?</a>
                </div>
            </form>
