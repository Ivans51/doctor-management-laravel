...
@section('content')
    <div class="max-w-5xl mx-auto px-4">
        ...
        <div id="settings" class="flex flex-col md:flex-row items-start space-x-0 md:space-x-6">
            <x-settings.profile-component :user="$user" :route="route('patient.settings')"></x-settings.profile-component>
            ...
            <section class="w-full md:w-3/5 mt-10 md:mt-0">
                <div class="bg-white rounded-lg shadow-sm">
                    <ul id="menu-setting" class="flex space-x-2 md:space-x-5 p-3 border-b overflow-x-auto">
                        <li class="px-3 py-2 whitespace-nowrap">
                            <a href="{{ route('patient.settings') }}" class="text-gray-600 hover:text-gray-900">
                                My Profile
                            </a>
                        </li>
                        <li class="px-3 py-2 whitespace-nowrap">
                            <a href="{{ route('patient.change.password') }}" class="text-gray-600 hover:text-gray-900">
                                Change Password
                            </a>
                        </li>
                    </ul>
