...
@section('content')
    <div class="max-w-5xl mx-auto px-4">
        <h3 class="font-bold text-2xl text-gray-800 mb-10">Notifications</h3>
        ...
        <div id="settings" class="flex flex-col md:flex-row items-start space-x-0 md:space-x-6">
            ...
            <section class="w-full md:w-3/5 mt-10 md:mt-0">
                <div class="bg-white rounded-lg shadow-sm">
                    ...
                    <div class="p-6">
                        <h2 class="font-bold text-lg text-gray-800 mb-6">Notifications</h2>
                        @if (sizeof($notifications) == 0)
                            <x-utils.not-data title="No notifications" description="You don't have any notifications" />
                        @else
                            <div class="space-y-4">
                                    ...
                                    <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                                        <div class="flex justify-between items-center px-4 py-3 border-b border-gray-100">
                                            ...
                                            <div class="text-right">
                                                <span class="text-xs text-gray-500">04/04/23</span>
                                            </div>
                                        </div>
