                    ...
                    <div class="flex-1">
                        ...
                        <div class="relative">
                            ...
                            <input class="pl-10 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                type="search" placeholder="Name, email" id="search_field" name="search_field">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Status</th>
                            <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Data
                            </th>
                            <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Actions</th>
                        </tr>
                ...
                html += `<tr class="bg-white rounded">
                            ...
                            <td class="px-4 py-2 text-center">
                                <a
                                    ...
                                    class="rounded text-blue-900 bg-blue-100 px-4 py-1 text-sm mr-2"
                                >
                                    Patients
                                </a>
                                <a
                                    href="/admin/payments?doctorId=${item.id}"
                                    class="rounded text-blue-900 bg-blue-100 px-4 py-1 text-sm"
                                >
                                    Payments
                                </a>
                            </td>
                            <td class="px-4 py-2 text-center">
                                <a
                                    ...
                                    class="rounded text-green-900 bg-green-100 px-4 py-1 text-sm mr-2"
                                >
                                    Edit
                                </a>
                                <button
