...
@section('content')
    <section class="max-w-3xl mx-auto mt-10 px-4">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Add Patient</h1>
            <a href="{{ route('admin.patients.index', isset($doctor) && $doctor ? ['doctorId' => $doctor->id] : []) }}" class="flex items-center text-gray-600 hover:text-gray-800">
                    ...
                    <div class="w-full md:col-span-2">
                        ...
                        @if(isset($doctor) && $doctor)
                            <div class="mt-2">
                                ...
                                <p class="text-gray-700 font-bold">{{ $doctor->name }}</p>
                            </div>
                        @else
                            <select name="doctor_id" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
